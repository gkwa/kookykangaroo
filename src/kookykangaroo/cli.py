...
def create_graph(
    ...
    uri: str = typer.Option(
        None, "--uri", "-u", help="Neo4j URI."
    ),
    username: str = typer.Option(
        None, "--username", help="Neo4j username."
    ),
    password: str = typer.Option(
        None, "--password", help="Neo4j password."
    ),
) -> None:
    ...
    try:
        ...
        password = password or os.environ.get("NEO4J_PASSWORD", "vertigo-avatar-susan-sharon-lava-2006")
